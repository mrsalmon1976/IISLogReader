    ...
    this.submitForm = function () {
        ...
        request.done(function (response) {
            if (response.success === false) {
                Utils.showError(that.selectorErrorMessage, 'Unable to sign in using the supplied user name and password');
            }
            else {
        ...
        request.fail(function (xhr, textStatus) {
            try {
                ...
                Utils.showError(that.selectorErrorMessage, 'A fatal error occurred: ' + err.message);
            }
        });
    };

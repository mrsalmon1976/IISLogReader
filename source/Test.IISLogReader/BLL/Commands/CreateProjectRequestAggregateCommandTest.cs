...
namespace Test.IISLogReader.BLL.Commands
{
    ...
    {
        private ICreateProjectRequestAggregateCommand _reateProjectRequestAggregateCommand;
        ...
        public void CreateProjectRequestAggregateCommandTest_SetUp()
        {
            ...
            _reateProjectRequestAggregateCommand = new CreateProjectRequestAggregateCommand(_dbContext, _projectRequestAggregateValidator);
        }
        ...
        public void Execute_ValidationFails_ThrowsException()
        {
            ...
            // execute
            TestDelegate del = () => _reateProjectRequestAggregateCommand.Execute(model);
        ...
        public void Execute_ValidationSucceeds_RecordInserted()
        {
            ...
            // execute
            _reateProjectRequestAggregateCommand.Execute(model);
        ...
        public void Execute_IntegrationTest_SQLite()
        {
            ...
            using (SQLiteDbContext dbContext = new SQLiteDbContext(filePath))
            {
                ...
                ICreateProjectRequestAggregateCommand createProjectRequestAggregateCommand = new CreateProjectRequestAggregateCommand(dbContext, validator);
